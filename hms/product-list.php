...
?>
											...
											<tr>
												...
												<td><?php echo $row['proslug'];?></td>
												<td><?php echo $row['procat'];?></td>
												<td><?php echo $row['proprice'];?></td>
												<td><?php echo $row['proquant'];?></td>
												<td><?php echo $row['procontains'];?></td>
												<td><?php echo $row['proexpiry'];?></td>
												<td><?php echo $row['promanufacturing'];?></td>
												<td><?php echo $row['prowarrenty'];?></td>
												<td><?php echo $row['promanufacturer'];?></td>
